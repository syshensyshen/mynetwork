...
syshen_convolution<Dtype>::syshen_convolution(cudnnHandle_t handle_) {
...
template<typename Dtype>
void syshen_convolution<Dtype>::Forward(Dtype *input, Dtype *output, Dtype *weights, Dtype *bias_weights) {
